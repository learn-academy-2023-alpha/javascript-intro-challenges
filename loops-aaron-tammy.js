...
// Create a for loop that logs the result of each number from 1 - 20 tripled. "Take every number from 1-20, and triple it"

for(let i = 1; i < 21; i++){
    console.log(i*3)
}
// Create a for loop that logs each even number from 1-20, and in the place of every odd number, returns the word "ODD".
    //if i is odd, log "odd", if even, log the number
for(let i = 1; i < 21; i++){
    if(i % 2 == 0){
        console.log(i)
    } else {
...
// Create the code that will log the largest number from the array.
            // Let's make sure we actually understand this and/or it's doing the right thing
