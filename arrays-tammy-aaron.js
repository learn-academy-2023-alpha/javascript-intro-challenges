...
var firstName = ["tammy", "aaron", "tran"]
var lastName = ["criner", "christopher", "thanh"]
...
firstName.sort().reverse()
lastName.sort().reverse()
console.log(firstName, lastName)

// Write the code that sorts all the names in alphabetical order in a single array.
var fullName = firstName.concat(lastName).sort()
